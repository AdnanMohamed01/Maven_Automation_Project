...
public class USPS_Reusable {
    public static void main(String[] args) {
        ...
        String results = Reusable_Actions.getTextAction(driver,"//*[@class='header-usps row']","Header Info");
        System.out.println("My header info is" + results);
        //enter the zipcode
